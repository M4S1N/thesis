...
\title{Construcción de bases wavelets discretas según la Transformada de Daubechies para detectar patrones en imágenes digitales}
\author{\\\vspace{0.25cm}Miguel Alejandro Asin Barthelemy}
\advisor{\\\vspace{0.25cm}MSc. Damian Valdés Santiago}
\degree{Licenciado en Ciencia de la Computación}
\faculty{Facultad de Matemática y Computación}
\date{28 de Noviembre de 2022\\\vspace{0.25cm}\href{https://github.com/M4S1N/thesis}{github.com/M4S1N/thesis}}
